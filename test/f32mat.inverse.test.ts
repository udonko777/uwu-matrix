...
describe("Matrix.inverse", () => {
  ...
  it("calculates the inverse of a 10x10 matrix", () => {
    ...
    const expectedInverse = fromRowMajor([
      [3.99641023, -5.01826418, 9.45294179, -2.1654234, 1.87732232, 11.2717514, 0.55053253, 4.49393732, -14.34681032, -8.69980916],
      [-0.49506158, 1.01784641, -2.04996559, -0.84668435, -0.500411, -2.66355933, 0.44572897, -0.24946909, 2.67877557, 2.55692676],
      [-1.53631195, 3.63910391, -6.22556358, 0.83306866, -2.47536438, -8.14387317, -1.13347387, -1.4064065, 9.4952928, 6.64681743],
      [1.75733329, -6.01137033, 14.00594811, -1.69456885, 2.61015718, 14.60243126, 3.01352945, 4.55701837, -17.92426398, -12.46674684],
      [0.468508, -2.56461378, 5.09037597, -0.1420901, 0.33263782, 6.57025767, 1.74329037, 0.9638409, -6.59947514, -4.81686106],
      [0.10354333, 2.12180697, -4.20669788, 0.6914939, -0.21347226, -2.95511405, -0.89869717, -1.190865, 3.30636947, 3.06534172],
      [-2.54440994, 5.68379034, -10.82918783, 1.39238554, -1.79184571, -13.82298828, -1.7305982, -3.66141537, 16.21098381, 9.48669659],
      [-0.52810966, -0.32574265, -1.88632602, 1.68955886, -0.43475104, -1.96336503, -0.84116336, -1.61565187, 3.33930806, 2.0700966],
      [1.57041713, -1.77368631, 6.15725075, -1.56687382, 1.58196125, 5.59717035, 0.45493914, 1.89756225, -7.51731463, -5.42968054],
      [-0.99448867, 0.8770808, -4.87237671, 0.97521565, 0.38450945, -2.42762109, -0.76570491, -1.84024532, 4.428094, 3.48700952],
    ]);
    const result = inverse(matrix);

    // 今のところ 1e-4までなら通る
    expect(result.value).toBeCloseMatrix(expectedInverse.value, 1e-5);
  });
